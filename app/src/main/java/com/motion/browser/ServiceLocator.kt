...
import com.motion.browser.data.AgentSettingsRepository
...
import com.motion.browser.agent.runtime.ScheduleSpec
...
object ServiceLocator {
    ...
    lateinit var database: MotionDatabase
        private set
    lateinit var agentSettings: AgentSettingsRepository
        private set
    lateinit var keyVault: com.motion.browser.agent.llm.KeyVault
        private set
    ...
    fun attach(context: Context) {
        ...
        synchronized(this) {
            ...
            keyVault = com.motion.browser.agent.llm.KeyVault(appContext)
    ...
    private val systemNotifier = Notifier { level, title, message ->
        runCatching {
            ...
            val channel = android.app.NotificationChannel("motion_alerts", "Motion Browser alerts", importance)
            nm.createNotificationChannel(channel)
            val notification = androidx.core.app.NotificationCompat.Builder(appContext, "motion_alerts")
