...
import com.motion.browser.data.ProviderEntity
...
fun SettingsScreen(modifier: Modifier = Modifier) {
    ...
    val settings by ServiceLocator.agentSettings.settings.collectAsState(
        initial = com.motion.browser.data.AgentSettings()
    )
            ...
            Card(Modifier.fillMaxWidth()) {
                Row(Modifier.padding(12.dp), verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column(Modifier.weight(1f).padding(start = 12.dp)) {
                        ...
                        Text(
                            "Xiaomi/Oppo/Realme kill background agents — exempt Motion Browser for reliable automation.",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                        )
                    }
                ...
                }) { Text("Disable optimization for Motion Browser") }
            }
        }
    }
