...
fun ChatDrawer(
    ...
    LaunchedEffect(Unit) {
        com.motion.browser.agent.runtime.ChatBus.events.collect { line ->
            lines.add(line)
                    ...
                    item {
                        Text(
                            "Describe a task — the agent will browse, click and fill forms for you.\n" +
                                "Contoh: \"Buka wikipedia, cari 'Motion Browser Pancasila', buka artikelnya, rangkum 3 poin.\"",
                ...
                Button(
                    onClick = {
                        ...
                        if (goal.isNotEmpty()) {
                            ...
                            lines.clear()
                            input = ""
                            com.motion.browser.agent.runtime.MotionAgentService.start(context)
                        }
                    },
