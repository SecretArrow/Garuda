package com.garuda.browser.ui.theme
...
/** Garuda brand: Garuda blue + gold. Adaptive light/dark (plan Prompt 7). */
private val GarudaBlue = Color(0xFF2A5CFF)
private val GarudaGold = Color(0xFFFFB300)
