...
// Permanent test evidence: print every unit test result to CI logs.
...
dependencies {
    implementation(project(":cdp-bridge"))
    ...
    // Real org.json on the JVM unit-test classpath (android.jar stubs it).
